...
class AMDemodula(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AMDemodula")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 200, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 300, 100, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=AMDemodula, options=None):
