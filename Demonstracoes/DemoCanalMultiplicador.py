...
class DemoCanalMultiplicador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DemoCanalMultiplicador")
...
def main(top_block_cls=DemoCanalMultiplicador, options=None):
